          ...
          <section class="team-members">
        	<div class="wrapper">
        		<div class="full inner title">
        			<h1 class="main-header">Meet The Team</h1>
        		...
        		<div class="third inner member">
        			<div class="inside">
	        			<div class="thumb">
	        				<img src="<?php bloginfo('template_directory'); ?>/images/team-5.jpg" alt="">
	        			</div>
        		...
        		<div class="third inner member">
        			<div class="inside">
	        			<div class="thumb">
	        				<img src="<?php bloginfo('template_directory'); ?>/images/team-6.jpg" alt="">
	        			</div>
	        			<div class="member-desc">
	        				<h3>Cody</h3>
	        			</div>
        		...
        		<div class="third inner member">
        			<div class="inside">
	        			<div class="thumb">
	        				<img src="<?php bloginfo('template_directory'); ?>/images/team-7.jpg" alt="">
	        			</div>
	        			<div class="member-desc">
	        				<h3>Connor</h3>
	        			</div>
        		...
        		<div class="third inner member">
                        			<div class="inside">
                	        			<div class="thumb">
                	        				<img src="<?php bloginfo('template_directory'); ?>/images/team-8.jpg" alt="">
                	        			</div>
                	        			<div class="member-desc">
                	        				<h3>Ethan</h3>
                	        			</div>
        		...
        		<div class="third inner member">
        			<div class="inside">
	        			<div class="thumb">
	        				<img src="<?php bloginfo('template_directory'); ?>/images/team-3.jpg" alt="">
	        			</div>
	        			<div class="member-desc">
	        				<h3>Garret</h3>
	        			</div>
        		...
        		<div class="third inner member">
        			<div class="inside">
	        			<div class="thumb">
	        				<img src="<?php bloginfo('template_directory'); ?>/images/team-2.jpg" alt="">
	        			</div>
	        			<div class="member-desc">
	        				<h3>Nick</h3>
	        			</div>
        		...
        		<div class="third inner member">
                    <div class="inside">
                	    <div class="thumb">
                	        <img src="<?php bloginfo('template_directory'); ?>/images/team-9.jpg" alt="">
                	    </div>
                	    <div class="member-desc">
                	        <h3>Brian</h3>
                	    </div>
        		...
        		<div class="third inner member">
        			<div class="inside">
	        			<div class="thumb">
	        				<img src="<?php bloginfo('template_directory'); ?>/images/team-1.jpg" alt="">
	        			</div>
	        			<div class="member-desc">
	        				<h3>Will</h3>
	        			</div>
        		...
        		<div class="full inner team-cat">
        			<h2>Faculty</h2>
        			<p style="max-width:500px;">Students work under the direct supervision of: </br>W. Brownlowe, BS, MEgr, MBACert, Sandan</br>Associate Professor of Engineering</br>Program Coordinator for Engineering Science and Technology</p>
					<p style="max-width:500px;">and the VTOL UAV lead: </br>J.J. Reymond, Engineering Faculty</br>Former Chief Infrastructure Architect at both AT&amp;T and IBM, and former Head of IBM GSA Laboratories in Sydney, Australia</p>
					<div class="divider red-divider"></div>
        		</div>
        		...
        		<div class="third inner member">
        			<div class="inside">
	        			<div class="thumb">
	        				<img src="<?php bloginfo('template_directory'); ?>/images/faculty-1.jpg" alt="">
	        			</div>
	        			<div class="member-desc">
	        				<h3>W. Brownlowe</h3>
	        			</div>
        		...
        		<div class="third inner member">
        			<div class="inside">
	        			<div class="thumb">
	        				<img src="<?php bloginfo('template_directory'); ?>/images/faculty-2.jpg" alt="">
	        			</div>
	        			<div class="member-desc">
	        				<h3>J.J. Reymond</h3>
	        			</div>
